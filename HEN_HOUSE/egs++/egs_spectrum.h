...
###############################################################################
#
#  EGSnrc egs++ spectrum detector application headers
...
#ifndef EGS_SPECTRUM_H
#define EGS_SPECTRUM_H
...
// application class
class APP_EXPORT spectrum_app : public EGS_AdvancedApplication {
