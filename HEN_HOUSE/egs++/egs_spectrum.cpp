...
###############################################################################
#
#  EGSnrc egs++ spectrum scoring application
...
###############################################################################
#
#   A small demonstration application to score a spectrum in a labeled set of
#   regions. Application specific options are set in the input file, in the
#   'scoring options' input block, e.g.,
#
...
#
#   The included sample input file ge-example.egsinp models a spectrum detector
#   inside a lead shield and scores the spectrum in the spectrum regions.
#
###############################################################################
*/


#include "egs_spectrum.h"

// describeUserCode
void spectrum_app::describeUserCode() const {
    egsInformation(
        "\n***************************************************"
        "\n*                                                 *"
...
// ausgab
int spectrum_app::ausgab(int iarg) {
...
// simulate one shower
int spectrum_app::simulateSingleShower() {
...
// resetCounter
void spectrum_app::resetCounter() {
...
// addState
int spectrum_app::addState(istream &data) {
...
// outputResults
void spectrum_app::outputResults() {
...
// outputResponse
void spectrum_app::outputResponse(EGS_ScoringArray *spec) {
...
// getCurrentResult
void spectrum_app::getCurrentResult(double &sum,
                                    double &sum2,
                                    double &norm,
                                    double &count) {
...
// startNewShower
int spectrum_app::startNewShower() {
